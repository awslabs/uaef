...
The site is MkDocs, built from [`docs/`](https://github.com/awslabs/uaef/tree/main/docs). Add or update the page alongside the code change:
...
[`LICENSE`](https://github.com/awslabs/uaef/blob/main/LICENSE) and
[`NOTICE`](https://github.com/awslabs/uaef/blob/main/NOTICE).
