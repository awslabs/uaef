...
| Deploy the service to AWS | [`uaef-service/README.md`](https://github.com/awslabs/uaef/blob/main/uaef-service/README.md) |
...
[`SECURITY.md`](https://github.com/awslabs/uaef/blob/main/SECURITY.md) for the full model.
