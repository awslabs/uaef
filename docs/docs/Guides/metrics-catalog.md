...
and the JSON files in `tests/data/`.
...
Source: `src/uaef/metrics/tool_calling.py`
...
Source: `src/uaef/metrics/response_quality.py`
...
Source: `src/uaef/metrics/responsible_ai.py`
...
Source: `src/uaef/metrics/performance.py`
...
Source: `src/uaef/metrics/multi_turn.py`
...
Source: `src/uaef/metrics/multi_agent.py`

Test cases use `multi_agent_trace` key instead of `trace`. See `tests/data/agent_utilization.json` etc.
...
Source: `src/uaef/metrics/reasoning.py`
